...
<html lang="en" data-theme="light">
	<head>
		...
		<title><?php if(!isset($_GET["page"])) {echo "Hack Hex | Together, we learn"; } if(isset($_GET["page"])) {echo "Page $_page | Hack Hex"; } ?></title>
		...
		<div class="container maxWidth1132 margin30" style="display: flex;">
			<div class="items">
				<?php 
					...
					$query = "SELECT * from question ORDER BY id DESC LIMIT $pStart, 10";
				...
				<?php
						...
						if(isset($_GET["page"]))
						{
							...
							if($_page==1) {
								...
								echo '<a href="https://' . $_SERVER['HTTP_HOST'] . '/' . ($_page-1) . '"><- Previous Page</a>';
							}
							
							echo '<a href="https://' . $_SERVER['HTTP_HOST'] . '/' . ($_page+1) . '" class="next">Next Page -></a>';
                            echo '</div>';
						} else {
                            echo '<div class="nav-link">';
